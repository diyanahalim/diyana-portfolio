...
import img10 from './images/Herstory Dashboard/1.jpg'
import img11 from './images/Herstory Dashboard/2.jpg'
import img12 from './images/Herstory Dashboard/3.jpg'

export const projects = [{
    id: 0,
    project_index: '01',
    project_image: [img10, img11, img12],
    project_title: '01. Data Visualisation on Sexual Harassment Cases',
    project_description: 'Built with Python with Dash, Herstory summarises the large sets of information regrading sexual harassment and crimes in New York City through interactive visualisation. In this dashboard, various charts and statistics are included to analyse trends and patterns of the crime.',
    link: 'https://abacus-laptop-shear-d3yd.onrender.com',
},
    {
    id: 1,
    project_index: '02',
    project_image: [img1, img2, img3],
    project_title: '02. Online Booking Website',
    ...
    link: 'https://beauty-spa-co-3-client.vercel.app',
}, {
    id: 2,
    project_index: '03',
    project_image: [img4, img5, img6],
    project_title: '03. Finding Tutor Website',
    ...
    project_title: '04. Todo List App',
